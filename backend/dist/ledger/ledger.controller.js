...
let LedgerController = class LedgerController {
    ...
    async getForUser(id) {
        const entries = await this.ledgerService.getEntriesForUser(id);
        return { entries };
    }
    async getMaster() {
        const entries = await this.ledgerService.getMasterEntries();
        return { entries };
    }
};
...
], LedgerController.prototype, "getForUser", null);
__decorate([
    (0, common_1.Get)('master'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], LedgerController.prototype, "getMaster", null);
exports.LedgerController = LedgerController = __decorate([
    (0, common_1.Controller)('ledgers'),
